...
class MenuView(arcade.View):
    ...
    def on_draw(self):
        self.clear()
        arcade.draw_lrwh_rectangle_textured(0,0,globalVars.ACTUAL_WIDTH,globalVars.ACTUAL_HEIGHT,self.bg)
        arcade.draw_text("Habia Una Vez...",FIFTY,self.window.height*.8,arcade.color.RED_DEVIL,40,anchor_x="left",anchor_y="center",font_name="Retro Gaming")
