...
class Game(arcade.View):
    ...
    def __init__(self,window,menu):
        ...
        self.thirdLevel = Room(self.window,menu,self,"Assets/Scripts/levelsInformation/level1.json",self.afterThird)
